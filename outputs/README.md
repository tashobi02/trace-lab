...
Source notebooks are committed with cleared outputs. Validation summaries under `environment/` contain compact results, while full local logs and executed notebooks remain in this directory. Do not write experiment evidence into source notebooks or overwrite historical records.
