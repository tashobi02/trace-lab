...
All maintained executable source is `.ipynb`. Source notebooks have cleared outputs; complete executed copies and logs are saved separately. Shared definition notebooks do not launch processes or install packages when loaded.
